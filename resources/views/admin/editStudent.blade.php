                            ...
                            <div class="card-body" id="InputInfo">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select form-control" id="program" name="program"
                                            ...
                                            <option value="Bachelor of Science in Secondary Education">Bachelor of Science
                                                in Secondary Education</option>
                                            ...
                                            <option value="Bachelor of Science in Agricultural and Biosystems Engineering">
                                                Bachelor of Science in Agricultural and Biosystems Engineering</option>
                                            <option value="Bachelor of Technical-Vocational Education">Bachelor of
                                                Technical-Vocational Education</option>
                                            <option value="Bachelor of Special Needs Education">Bachelor of Special Needs
                                                Education</option>
                                            <option value="Bachelor of Early Childhood Education">Bachelor of Early
                                                Childhood Education</option>
                                            <option value="Bachelor of Elementary Education">Bachelor of Elementary
                                                Education</option>
                                        </select>

                                        <!-- Text input for custom program (hidden initially) -->
                                        <div id="programInputContainer" class="hidden">
                                            <input type="text" class="form-control" id="programInput"
                                                name="customProgram" placeholder="Enter your program">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <select class="form-control form-select" id="major" name="major"
                                        ...
                                        <div id="majorInputContainer" class="hidden">
                                            <input type="text" class="form-control" id="majorInput"
                                                name="customMajor" placeholder="Enter your major">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-primary" id="editstudentpatient"
                                            name="editstudentpatient">
                                            Save
                                        </button>
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                const programMajors = {
                    'Click to type...': [],
                    'Bachelor of Science in Secondary Education': ['Click to type...', 'Filipino', 'English',
                        'Mathematics'
                    ],
                    ...
                    'Bachelor of Technical-Vocational Education': ['Click to type...',
                        'Agricultural Crop Production', 'Animal Production'
                    ],
                ...
                if (patientData.student.student_program && !checkIfExistsInDropdown('#program', patientData.student
                        .student_program)) {
                ...
                if (patientData.student.student_major && !checkIfExistsInDropdown('#major', patientData.student
                        .student_major)) {
