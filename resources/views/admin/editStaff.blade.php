                            ...
                            <div class="card-body" id="InputInfo">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select  form-control" id="office" name="office">
                                            ...
                                            <option value="Office of Student Affairs and Services">Office of Student Affairs
                                                and Services</option>
                                            <option value="Campus Clinic">Campus Clinic</option>
                                            <option value="System and Data Management Division Office (SDMD)">System and
                                                Data Management Division Office (SDMD)</option>
                                            ...
                                            <option value="University Learning Resource Center Office (ULRC)">University
                                                Learning Resource Center Office (ULRC)</option>
                                            <option value="Corporate Enterprise Development Unit Office (CEDU)">Corporate
                                                Enterprise Development Unit Office (CEDU)</option>
                                        ...
                                        <div id="officeInputContainer" class="hidden">
                                            <input type="text" class="form-control" id="officeInput"
                                                name="customOffice" placeholder="Enter your office">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-primary" id="editstaffpatient"
                                            name="editstaffpatient">
                                            Save
                                        </button>
        ...
        <script>
            $(document).ready(function() {
                ...
                function populatePatientForm(data) {
                    ...
                    $('#profilePic').attr('src', `uploads/${patientData.patient.patient_profile}` ||
                        'default-image.jpg');
                ...
                if (patientData.staff.staff_office && !checkIfExistsInDropdown('#office', patientData.staff
                        .staff_office)) {
                    $('#office').hide();
