@extends('admin.app')
@section('title', 'Patient Profile Staff')
@section('content')
    <!-- Main Content -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="medicalRecordDetailsModalLabel">Medical
                                                        Record Details</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><strong>Date Uploaded:</strong> <span id="details_med_date"></span>
                                                    </p>
