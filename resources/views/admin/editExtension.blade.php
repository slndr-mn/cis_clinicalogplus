                            ...
                            <div class="card-body" id="InputInfo">
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="extenID" name="extenID"
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-primary" id="editextenpatient"
                                            name="editextenpatient">
                                            Save
                                        </button>
        ...
        <script>
            $(document).ready(function() {
                ...
                function populatePatientForm(patientData) {
                    ...
                    document.getElementById('emergencyContactName').value = patientData.emergencyContact
                        .emcon_conname || '';
                    document.getElementById('relationship').value = patientData.emergencyContact.emcon_relationship ||
                        '';
                    document.getElementById('emergencyContactNumber').value = patientData.emergencyContact
                        .emcon_connum || '';
                    document.getElementById('Status').value = patientData.patient.patient_status || '';
                    document.getElementById('profilePic').src = `uploads/${patientData.patient.patient_profile}` ||
                        'default-image.jpg';
                }
