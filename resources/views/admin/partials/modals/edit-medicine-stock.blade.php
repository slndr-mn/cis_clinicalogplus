    ...
    <div class="modal-content">
      ...
      <form id="editForm">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <p class="fw-light">Date & Time Added: <span id="editdatetimeadded">2025-07-07 08:00</span></p>
            </div>

            <div class="col-sm-12">
              <div class="form-group form-group-default">
                <label>ID</label>
                <input id="editid" name="editid" type="text" class="form-control" readonly value="00123">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group form-group-default">
                ...
                <input id="editquantity" name="editquantity" type="number" class="form-control" value="100">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group form-group-default">
                ...
                <input id="editED" name="editED" type="date" class="form-control" value="2026-12-31">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group form-group-default">
                ...
                <select id="editDisable" name="editDisable" class="form-control">
                  <option value="0">No (Enabled)</option>
                  <option value="1">Yes (Disabled)</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer border-0">
          <button type="button" class="btn btn-primary" id="updatemedicine">Edit</button>
