@extends('admin.app')
@section('title', 'Add Extension Patient')
@section('content')
{{ Breadcrumbs::render('patientRecord.addextension') }}
    <!-- Main Content -->
                            ...
                            <form id="extenForm" action="patientcontrol.php" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="extentID" name="extentID"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control" id="street"
                                            name="street" placeholder="Enter street address" required />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-primary" id="addextensionpatient"
                                            name="addextensionpatient">
                                            Submit
                                        </button>
    ...
    @push('scripts')
        <script>
            ...
            function restoreFormFields() {
                const formFields = ['lastName', 'firstName', 'middleName', 'dob', 'sex', 'extentID', 'role', 'region',
